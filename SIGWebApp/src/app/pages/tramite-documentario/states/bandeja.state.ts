...
export class BandejaState {
  ...
  public static loadDocuments(ctx: Context, action: FiltroAction) {
    ...
    return this.api.getBandeja(buzonUsuario.loginUsuarioBuzon, bandejaFiltro).pipe(
      tap(documentos =>{
  ...
  public static searchDocuments(ctx: Context, action: BuscarAction) {
    ...
    ctx.patchState({bandejaActiva:'e',bandejas:new Bandejas(), bandejaBuscar, pending: true });
