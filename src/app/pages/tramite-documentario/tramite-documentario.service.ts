...
import {
  DocumentoInterno,
  BandejaInternaRespuesta,
} from '../../@models/tramite/documento-interno';
...
export class TramiteService {
  ...
  buscarBandeja(
    ...
    return this.http.get({
      uri: `api/buscarDocumento/${loginUsuarioBuzon.trim()}/${
        s.tipoBusqueda
      }/${s.valorBusqueda.trim()}`,
      open: false,
      close: false,
    });
  }
  buscarBandejaInterna(
    loginUsuarioBuzon: string,
    s: BuscarBandeja
  ): Observable<BandejasInternas> {
    return this.http.get({
      uri: `api/buscarDocumentoInterno/${loginUsuarioBuzon.trim()}/${
        s.tipoBusqueda
      }/${s.valorBusqueda.trim()}`,
      open: false,
      close: false,
  ...
  buscarDestinatario(
    ...
    return this.http
      .get({
        uri:
          loginUsuario == null
            ? `api/buscarDestinatario/${porNombre}/${tipoBusqueda}/${valorBusqueda.trim()}`
  ...
  buscarArea(valorBusqueda: any): Observable<Area[]> {
    return this.http
      .get({
  ...
  guardarDocumento(body: any): Observable<ItemResultado> {
  ...
  guardarDocumentoInterno(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  guardarValorizacionContabilidad(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  buscarContrato(body: any): Observable<BuscarContrato[]> {
  ...
  guardarOTMantenimiento(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  derivarDocumento(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  derivarDocumentoInterno(body: any): Observable<ItemResultado[]> {
    return this.http.post({
  ...
  derivarDocumentoInternoValorizacion(body: any): Observable<ItemResultado[]> {
    return this.http.post({
  ...
  buscarDocumento(body: any): Observable<ResultadoBuscarDocumento[]> {
    //console.log(JSON.stringify(body))
    return this.http.post({
  ...
  archivosDocumento(
    codigoDocumento: any,
    loginUsuarioBuzon: any
  ): Observable<ArchivosAnexos> {
    return this.http.get({
  ...
  archivosDocumentoInterno(
    loginUsuarioBuzon: any,
    codigoDocumento: any,
    tipo: any
  ): Observable<ArchivoDocumento[]> {
    return this.http.get({
  ...
  detalleDocumento(codigoDocumento: any): Observable<DetalleDocumento[]> {
    return this.http.get({
  ...
  //#region  Atenciones****************************************
  listarAtenciones(codigoDocumento: any): Observable<DetalleDocumento[]> {
    return this.http.get({
  ...
  listarValorizacion(codigoDocumento: any): Observable<BuscarContrato> {
    return this.http.get({
  ...
  // Guardar la atención
  atenderDocumento(body: any): Observable<Resultado> {
    return this.http.post({
  ...
  recuperarDerivacion(body: any): Observable<Resultado> {
    return this.http.post({
  ...
  cancelarAtencion(body: any): Observable<Resultado> {
    return this.http.post({
  ...
  adjuntarArchivoInterno(form: any, file: File): Observable<UploadEvent> {
  ...
  adjuntarArchivo(form: any, file: File): Observable<UploadEvent> {
    return this.Upload.upload({
  ...
  actualizarAdjunto(
    ...
    codigoTipoDocumentoAdjunto: number
  ): Observable<Resultado> {
    return this.http.get({
  ...
  guardarArchivoParaFirmarMemoAdjunto(
    codigoDocumento: any,
    codigoDocumentoAdjunto: any
  ): Observable<{
    rutaOrigen: string;
    rutaDestino: string;
    urlServicio: string;
  ...
  guardarArchivoParaFirmarInterno(
    codigoDocumento: any,
    codigoDocumentoAdjunto: any
  ): Observable<{
    rutaOrigen: string;
  ...
  guardarArchivoFirmado(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  eliminarArchivo(codigoDocumento: any, itemId: any): Observable<any> {
    return this.http.get({
      uri: `api/eliminarArchivo/${codigoDocumento}/${itemId}`,
      open: true,
      close: true,
  ...
  buscarUsuario(valorBusqueda: any): Observable<UsuarioApp[]> {
    return this.http
      .get({
  ...
  getReporteInternoPdf(
    r: DocumentoInternoFiltro
  ): Observable<Blob> | Observable<any> {
    ...
    const uri =
      r.tipoEmisor == 0 && r.prefijoGerencia == 'G'
        ? `api/repDocIntGPDF/${r.loginUsuario}/${fi}/${ff}/${r.prefijoGerencia}/${r.codigoTipoDocumento}/${r.codigoEstado}`
        : r.tipoEmisor == 0
        ? `api/repDocIntGLyAreaPDF/${r.loginUsuario}/${fi}/${ff}/${r.prefijoGerencia}/${r.codigoTipoDocumento}/${r.codigoEstado}`
        : r.tipoEmisor == 1
        ? `api/repDocIntGLyAreaPDF/${r.loginUsuario}/${fi}/${ff}/${r.prefijoArea}/${r.codigoTipoDocumento}/${r.codigoEstado}`
        : r.tipoEmisor == 2
        ? `api/repDocIntPersonaPDF/${r.loginUsuario}/${fi}/${ff}/${r.codigoTipoDocumento}/${r.codigoEstado}`
        : '';
    return this.http.get({
      uri: uri,
      open: true,
  ...
  getReporteExternoPdf(
    r: DocumentoExternoReporte
  ): Observable<Blob> | Observable<any> {
    const fi = formatDate(r.fechaInicio, 'yyyyMMdd', 'en-US');
    const ff = formatDate(r.fechaFin, 'yyyyMMdd', 'en-US');
  ...
  guardarRemitente(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  getDetalleSielse(codigoDocumento: any): Observable<Sielse[]> {
    return this.http.get({
  ...
  buscarDoc(body: SeguimientoFiltro): Observable<SeguimientoDocumento[]> {
    ...
    if (copia.check) {
      copia.fechaInicioTexto = formatDate(
        copia.fechaInicio,
        'yyyyMMdd',
        'en-US'
      );
  ...
  graphReport(codigoDocumento: any): Observable<GrafoReporte> {
    return this.http.get({
  ...
  getBandejaDocumentoInterno(
    loginBandeja: string,
    b: BandejaFiltro
  ): Observable<BandejaInternaRespuesta> {
    const fi = formatDate(b.fechaInicio, 'yyyyMMdd', 'en-US');
    const ff = formatDate(b.fechaFin, 'yyyyMMdd', 'en-US');
    return this.http.get({
      uri: `api/BandejaDocumentoInterno/${loginBandeja.trim()}/${
        b.bandeja
      }/${fi}/${ff}`,
      open: false,
      close: false,
  ...
  getReporteDocumentoInterno(
    b: DocumentoInternoFiltro
  ): Observable<DocumentoInterno[]> {
    const fi = formatDate(b.fechaInicio, 'yyyyMMdd', 'en-US');
    const ff = formatDate(b.fechaFin, 'yyyyMMdd', 'en-US');
    const prefijo =
      b.tipoEmisor == 0
  ...
  derivarArchivoFinal(form: any, file: File): Observable<UploadEvent> {
    return this.Upload.upload({
  ...
  derivarInternoFinal(body: any): Observable<ItemResultado> {
  ...
  derivarDeFinal(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  aprovarDeFinal(body: any): Observable<ItemResultado> {
    return this.http.post({
  ...
  aprobarArchivo(form: any, file: File): Observable<UploadEvent> {
    return this.Upload.upload({
  ...
  aprobarValidacion(form: any): Observable<ItemResultado> {
    return this.http.post({
      body: form,
  ...
  rechazarDocumento(form: any): Observable<ItemResultado> {
    return this.http.post({
      body: form,
