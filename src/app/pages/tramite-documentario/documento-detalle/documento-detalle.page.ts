...
export class DocumentoDetallePage implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.doc.codigoDocumentoTramite != null) {
      ...
      this.cancelarAtencion =
        this.doc.bandeja == 'a' && this.buzonActual.permiso > 1;
    }
  }
  ...
  deshacerDerivacion() {
    Swal.fire({
      title: `<span class="swalquestion-title">¿Desea recuperar el documento: ${this.doc.codigoDocumentoTramite} ?</span>`,
      icon: 'question',
  ...
  deshacerAtencion() {
    Swal.fire({
      title: `<span class="swalquestion-title">¿Desea cancelar la atención del documento: ${this.doc.codigoDocumentoTramite} ?</span>`,
      icon: 'question',
      showCancelButton: true,
      confirmButtonColor: '#607d8b',
      cancelButtonColor: '#f44336',
